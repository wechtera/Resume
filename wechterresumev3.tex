...
\address{ (412)~$\cdot$~651~$\cdot$~4721 $\diamond$ wechtera@gmail.com $\diamond$ 5339 Dresden Way \\ Pittsburgh, Pa 15201 } %  address
...
%Other Related Skills & Building and troubleshooting desktop hardware, backup systems, and network maintenance
\end{tabular}
\vspace{-5mm}
\end{rSection}
